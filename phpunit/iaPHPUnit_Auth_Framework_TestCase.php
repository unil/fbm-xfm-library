...
require_once(__DIR__.'/../../xfm/lib/Util/Auth.php');
require_once(__DIR__.'/../../fbm/xfm/iaAuth.php');
require_once(__DIR__.'/../../xfm/lib/Core/Bootstrap.php');
require_once(__DIR__.'/../../fbm/xfm/iaBootstrap.php');
